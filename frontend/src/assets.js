...
export const PhysicsAssets = (() => {
  ...
  function body(ctx, s, o = {}, role = "accent") {
    const r = o.radius || Math.min(o.width || 40, o.height || 40) / 2,
      c = colors(s, o, role),
      depth = PhysicsExperience.profile(s).depth;
    setup(ctx, s, {
      ...o,
  ...
  function wheel(ctx, s, o = {}) {
    const r = o.radius || Math.min(o.width || 34, o.height || 34) / 2,
      c = colors(s, o, "uncertainty");
    setup(ctx, s, o);
  ...
  function segment(ctx, s, o = {}, role = "tension") {
    const end = o.end || point(o.width || 80, 0),
      c = colors(s, o, role);
    setup(ctx, s, o);
  ...
  function spring(ctx, s, o = {}) {
    const end = o.end || point(o.width || 100, 0),
      turns = o.turns || 12,
      amp = o.amplitude || 9,
      c = colors(s, o, "acceleration");
    setup(ctx, s, o);
    ctx.strokeStyle = c.fill;
  ...
  function track(ctx, s, o = {}) {
    const pts = o.points || [],
      color = o.outline || V.token(s, "colors", "text", "#152536");
    ...
    if (!o.dashed && o.ties !== false) {
      ...
      for (let i = 1; i < pts.length; i++) {
        const a = pts[i - 1],
          ...
          count = Math.max(1, Math.floor(length / 24)),
          ux = (b.x - a.x) / length,
          uy = (b.y - a.y) / length,
          nx = -uy * 7,
          ny = ux * 7;
  ...
  function star(ctx, s, o = {}) {
    const r = o.radius || Math.min(o.width || 70, o.height || 70) / 2,
      c = colors(s, o, "energy");
  ...
  function fluidSurface(ctx, s, o = {}) {
    const w = o.width || 130,
      h = o.height || 70,
      c = o.fill || V.token(s, "colors", "electric_field", "#006D77");
    setup(ctx, s, o);
    ctx.fillStyle = c;
  ...
  function fieldLine(ctx, s, o = {}) {
    ...
    ctx.save();
    ctx.strokeStyle =
      o.outline || V.token(s, "colors", "electric_field", "#006D77");
  ...
  function semanticArrow(role) {
    return (ctx, s, o = {}) => {
      const end = o.end || point(o.x + (o.width || 80), o.y),
        dx = end.x - o.x,
        dy = -(end.y - o.y);
  ...
  const forceArrow = semanticArrow("net_force"),
    velocityArrow = semanticArrow("velocity"),
    accelerationArrow = semanticArrow("acceleration");
  function torqueArc(ctx, s, o = {}) {
    const r = o.radius || 42,
      start = o.startAngle ?? -0.8,
      end = o.endAngle ?? 2.8,
      color = o.fill || V.token(s, "colors", "net_force", "#C2410C");
    ctx.save();
    ctx.strokeStyle = color;
    ...
    ctx.stroke();
    const a = end,
      tip = point(o.x + Math.cos(a) * r, o.y + Math.sin(a) * r),
      back = point(o.x + Math.cos(a - 0.14) * r, o.y + Math.sin(a - 0.14) * r);
  ...
  function ruler(ctx, s, o = {}) {
    const length = o.width || 160,
      div = o.divisions || 10;
    ctx.save();
    ctx.translate(o.x, o.y);
    ctx.rotate(o.rotation || 0);
    ctx.strokeStyle =
      o.outline || V.token(s, "colors", "text_muted", "#526577");
  ...
  function collisionFlash(ctx, s, o = {}) {
    ...
    for (let i = 0; i < 16; i++) {
      const a = (i * Math.PI) / 8,
        rr = i % 2 ? r * progress : r * 0.42 * progress;
      ctx.lineTo(Math.cos(a) * rr, Math.sin(a) * rr);
    }
    ctx.closePath();
    ctx.fill();
  ...
  function callout(ctx, s, o = {}) {
    ...
    lines
      .slice(0, 3)
      .forEach((line, i) => ctx.fillText(line, x + 12, y + 22 + i * 17));
    ctx.restore();
  }
  const library = {
    sphere,
