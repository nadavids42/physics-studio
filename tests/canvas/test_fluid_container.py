...
def test_fluid_container_player_is_accessible_and_responsive():
    buoy = build_fluid_document(kind="buoyancy", message="Floating", seed=1, submerged_fraction=0.6)
    pressure = build_fluid_document(
        kind="pressure", message="Deep pressure", seed=2, depth=5, maximum_depth=10
    )
