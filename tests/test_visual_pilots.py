...
def test_pilot_pages_retain_all_four_learning_modes():
    ...
    from physics_playground.pages import cannonball as cannon_page
    from physics_playground.pages import orbital_gravity as orbit_page
    from physics_playground.pages import pendulum as pendulum_page
