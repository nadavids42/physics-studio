...
SCENE=r"""
const scene={draw(ctx,s){const {width:w,height:h}=s.transform;ctx.clearRect(0,0,w,h);ctx.fillStyle='#F4F8FC';ctx.fillRect(0,0,w,h);ctx.strokeStyle='#263238';ctx.lineWidth=4;
