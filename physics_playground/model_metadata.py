...
def _metadata(
    ...
    return ModelMetadata(
        simulation_id,
        tuple(
            ModelAssumption(f"assumption_{index}", statement)
            for index, statement in enumerate(assumptions, 1)
        ),
        limitations,
    )
...
MODEL_METADATA = {
    ...
    for item in (
        ...
        _metadata(
            "diffusion",
            (
                "Independent seeded steps",
                "Fixed step size and timestep",
                "No boundaries or particle interactions",
            ),
        ),
        _metadata(
            "buoyancy",
            (
                "Uniform object and fluid densities",
                "Static equilibrium or fully submerged state",
                "No surface tension or drag dynamics",
            ),
        ),
        _metadata(
            "fluid_pressure",
            ("Fluid at rest", "Constant density and gravity", "Uniform surface pressure"),
        ),
        _metadata(
            "magnetic_forces",
            (
                "Uniform magnetic field",
                "Nonrelativistic point charge or straight wire",
                "Vectors represented in the screen plane",
            ),
        ),
        _metadata(
            "electric_fields",
            (
                "Ideal stationary point charges",
                "Vacuum Coulomb law",
                "Minimum-distance singularity exclusion for visualization",
            ),
        ),
        _metadata(
            ...
            (
                ...
                "Flat boundary between uniform isotropic media",
                "No absorption or dispersion",
            ),
        ),
        _metadata(
        ...
        _metadata(
            "doppler_effect",
            (
                "Stationary uniform sound medium",
                "Classical subsonic motion",
                "One-dimensional source and observer",
            ),
        ),
        _metadata(
            "wave_interference",
            (
                ...
                "Ideal sinusoidal traveling waves",
                "No damping, reflection, or dispersion",
            ),
        ),
        _metadata(
            "roller_coaster",
            (
                "Point-mass car",
                "Uniform gravity",
                "Piecewise-linear track and optional constant loss per meter",
            ),
        ),
        _metadata(
        ...
        _metadata(
            "torque_levers",
            ("Rigid massless lever", "Frictionless pivot", "Forces perpendicular to the beam"),
        ),
        _metadata(
            "center_of_mass",
            (
                "Objects represented by point masses",
        ...
        _metadata(
            "bumper_cars",
            ("One-dimensional motion", "Instantaneous collision", "No external horizontal force"),
        ),
        PROJECTILE_MODEL_METADATA,
        _metadata(
            "boing",
            ("Hooke's law", "Point mass and massless spring", "Linear damping where enabled"),
        ),
        _metadata(
            "pendulum",
            ("Point bob and rigid massless rope", "Fixed gravity", "No air or pivot friction"),
        ),
        _metadata(
            "orbital_gravity",
            ("Fixed central mass", "Test-particle planet", "No drag or third-body perturbations"),
        ),
        _metadata("earth_tunnel", ("Spherical planet", "Vacuum tunnel", "No planetary rotation")),
        _metadata(
            "double_pendulum",
            ("Point masses and rigid rods", "No damping", "Ideal frictionless pivots"),
        ),
    )
}
