(() => {
  ...
  // src/scenes/mechanics/bumper-cars-comparison.js
  ...
  var scene = {
    ...
    draw(ctx, frame) {
      ...
      const tracks = frame.tracks, c1 = PhysicsVisuals.token(frame, "colors", "graph_1", "#0072B2"), c2 = PhysicsVisuals.token(frame, "colors", "graph_2", "#D55E00");
      comparisonCar(
        ctx,
        frame,
